...
/**
 * //////////// Custom APp EDIT-TEXT //////////
 * /////////// IN THIS EDIT TEXT WE HAVE A DRAWABLE LISTENER
 */
...
//        return super.onTouchEvent(event);
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableBottom != null
                ...
                clickListener.onClick(DrawablePosition.BOTTOM,event);
                return super.onTouchEvent(event);
            }

            if (drawableTop != null
                    && drawableTop.getBounds().contains(actionX, actionY)) {
                clickListener.onClick(DrawablePosition.TOP,event);
                return super.onTouchEvent(event);
            }
            ...
            if (drawableLeft != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener
                            .onClick(DrawablePosition.LEFT,event);
            ...
            if (drawableRight != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener
                            .onClick(DrawablePosition.RIGHT,event);
                    event.setAction(MotionEvent.ACTION_CANCEL);
                    return false;
                }
                return super.onTouchEvent(event);
